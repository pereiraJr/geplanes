...
<c:choose>
			...
			<n:panel title="Tratamento">
			   ...
			   <t:detalhe name="planosAcao" id="planosAcao" labelnovalinha="Novo plano de ação" showBotaoNovaLinha="true" showBotaoRemover="true" onNewLine="configQuem(this)">
					...
					<n:column header="Quem">
						<t:property name="usuario" style="width:120px" itens="${listaUsuarios}" onChange="onChangeQuem(${index})"/>
						<t:property name="textoQuem" rows="3" style="width:120px"/>
					</n:column>
					<t:property name="dtPlano" style="width:72px"/>
					<n:column header="Quanto custa">
						<label>Planejado:</label></br>
		...
		<c:otherwise>
			...
			<n:panel title="Tratamento">
				...
				<br>
			   <n:panel><span class="desc">Plano de Ação</span></n:panel>
			   <t:detalhe name="planosAcao"  id="planosAcao" labelnovalinha="Novo plano de ação" showBotaoNovaLinha="${podeCriarPlanoAcao}" showBotaoRemover="false" onNewLine="configQuem(this)">
			   		<c:choose>
			   			...
			   			<c:otherwise>
			   				<c:choose>
			   					<c:when test="${planoAcao.podeEditarStatus}">
									...
									<n:column header="Quem">
										<t:property name="usuario" style="width:120px" readonly="true" class="readonlyField"/>
										<t:property name="textoQuem" rows="3" style="width:120px" readonly="true" class="readonlyField"/>
									</n:column>
									<t:property name="dtPlano" write="true" type="hidden" readonly="true" class="readonlyField"/>
									<n:column header="Quanto">
										<label>Planejado:</label>
										<t:property name="quantoP" style="width:100px" readonly="true" class="readonlyField"/>
										</br></br>
										<label>Realizado:</label>
										<t:property name="quantoR" style="width:100px" readonly="true" class="readonlyField"/>
									</n:column>
									<t:property name="textoComoMedir" rows="3" style="width:140px" readonly="true" class="readonlyField"/>
									<n:column header="Status">
										<t:property name="status" includeBlank="false"/>
										<br>
										<t:property name="descricaoDtAtualizacaoStatus" mode="output"/>
