...
public final class normaEntrada_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar re = /^\\d+(?:\\.(?:[a-z]|\\d+))*$/;\r\n");
      out.write("\t\tvar casamento;\r\n");
      out.write("\t\tvar valido = true;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t$(\"input[name$=indice]\").each(function(){\r\n");
      out.write("\t\t\tvar indice = $(this).val();\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\tcasamento = re.exec(indice);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\tif (!casamento) {\r\n");
      out.write("\t\t\t\talert(\"O índice \" + indice + \" não está em um formato válido. Exemplos de formatos aceitos: 1, 1.1, 1.a, etc.\");\r\n");
  ...
  private boolean _jspx_meth_t_entrada_0(PageContext _jspx_page_context)
    ...
    _jspx_th_t_entrada_0.setTitulo("Cadastro de Normas");
    _jspx_th_t_entrada_0.setDynamicAttribute(null, "submitconfirmationscript", new String("validaFormulario()"));
    _jspx_th_t_entrada_0.setJspBody(new normaEntrada_jspHelper( 0, _jspx_page_context, _jspx_th_t_entrada_0, null));
  ...
  private boolean _jspx_meth_t_janelaEntrada_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_janelaEntrada_0.setJspBody(new normaEntrada_jspHelper( 1, _jspx_page_context, _jspx_th_t_janelaEntrada_0, null));
  ...
  private boolean _jspx_meth_t_tabelaEntrada_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_tabelaEntrada_0.setJspBody(new normaEntrada_jspHelper( 2, _jspx_page_context, _jspx_th_t_tabelaEntrada_0, null));
  ...
  private boolean _jspx_meth_t_property_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_2.setCols(new Integer(100));
  ...
  private boolean _jspx_meth_t_detalhe_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_detalhe_0.setName("listaRequisitoNorma");
    _jspx_th_t_detalhe_0.setDynamicAttribute(null, "labelnovalinha", new String("Novo requisito"));
    _jspx_th_t_detalhe_0.setJspBody(new normaEntrada_jspHelper( 3, _jspx_page_context, _jspx_th_t_detalhe_0, null));
  ...
  private boolean _jspx_meth_n_column_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_n_column_0.setHeader("Índice");
    _jspx_th_n_column_0.setJspBody(new normaEntrada_jspHelper( 4, _jspx_page_context, _jspx_th_n_column_0, null));
  ...
  private boolean _jspx_meth_n_body_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_n_body_0.setJspBody(new normaEntrada_jspHelper( 5, _jspx_page_context, _jspx_th_n_body_0, null));
  ...
  private boolean _jspx_meth_t_property_4(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_4.setName("indice");
    _jspx_th_t_property_4.setDynamicAttribute(null, "style", new String("width:70px"));
  ...
  private boolean _jspx_meth_t_property_5(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_5.setCols(new Integer(160));
    _jspx_th_t_property_5.doTag();
    return false;
  }

  private class normaEntrada_jspHelper
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
    private javax.servlet.jsp.tagext.JspTag _jspx_parent;
    private int[] _jspx_push_body_count;

    public normaEntrada_jspHelper( int discriminator, JspContext jspContext, javax.servlet.jsp.tagext.JspTag _jspx_parent, int[] _jspx_push_body_count ) {
