package org.apache.jsp.WEB_002dINF.jsp.transportadora.crud;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class transportadoraEntrada_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("\tfunction validaCNPJ(){\r\n");
      out.write("\t\tvar cnpj = form.cnpj.value;\r\n");
      out.write("\t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/transportadora/crud/Transportadora\";\r\n");
      out.write("\t\t$.getJSON(url, {ACAO: \"validaCNPJ\", cnpj: cnpj}, function(data){\r\n");
      out.write("\t\t\tif(data.error==true){\r\n");
      out.write("\t\t\t\talert(\"Digite um CNPJ válido!\");\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t//TODO preencher os inputs com os dados do sindicalizado\r\n");
      out.write("\t\t\t\t$(\"#campos\").show();\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\tif($(\"#certificacao\").is(\":checked\")) {\r\n");
      out.write("\t \t\r\n");
      out.write("\t \t$('#descricao').parent().parent().show();\r\n");
      out.write("\t \t$('#validadeCertificacaoOutros').parent().parent().show();\r\n");
      out.write("\t \t\t\r\n");
      out.write("\t  }\t\r\n");
      out.write("\t  else {\r\n");
      out.write("\t  \r\n");
      out.write("\t \t$('#descricao').parent().parent().hide().val('');\r\n");
      out.write("\t \t$('#validadeCertificacaoOutros').parent().parent().hide().val(''); \r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("}\t\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\tfunction certificacaoIso9001() {\r\n");
      out.write("\t\tif($(\"#certificacaoIso\").is(\":checked\")) {\r\n");
      out.write("\t\t\t$('#validadeIso').parent().parent().show();\r\n");
      out.write("\t\t}\t\r\n");
      out.write("\t  \telse {\r\n");
      out.write("\t\t\t$('#validadeIso').parent().parent().hide().val('');\r\n");
      out.write("\t\t}\r\n");
      out.write("}\t\r\n");
      out.write("\t\r\n");
      out.write("\tfunction certificacaoSassmaq2() {\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif($(\"#certificacaoSassmaq3\").is(\":checked\")) {\r\n");
      out.write("\t\t\t$('#validadeSassmaq2').parent().parent().show();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse {\r\n");
      out.write("\t\t\t$('#validadeSassmaq2').parent().parent().hide().val('');\r\n");
      out.write("\t\t}\r\n");
      out.write("}\r\n");
      out.write("\t\r\n");
      out.write("\t function possuiSeguro2() {\r\n");
      out.write("\t \r\n");
      out.write("\t \t\tif($(\"#possuiSeguro3\").is(\":checked\")) {\r\n");
      out.write("\t \t\t\t$('#rctrC2').parent().parent().show();\r\n");
      out.write("\t \t\t\t$('#rcfdC2').parent().parent().show();\r\n");
      out.write("\t \t\t\t$('#danosAmbientais3').parent().parent().show();\r\n");
      out.write("\t \t\t}\r\n");
      out.write("\t \t\telse {\r\n");
      out.write("\t \t\t\t$('#rctrC2').parent().parent().hide();\r\n");
      out.write("\t \t\t\t$('#rcfdC2').parent().parent().hide();\r\n");
      out.write("\t \t\t\t$('#danosAmbientais3').parent().parent().hide();\r\n");
      out.write("\t \t\t}\r\n");
      out.write("\t \t\t\r\n");
      out.write("}\t\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\tcheck();\t\r\n");
      out.write("\t\tcertificacaoIso9001();\r\n");
      out.write("\t\tcertificacaoSassmaq2();\r\n");
      out.write("\t\tpossuiSeguro2();\r\n");
      out.write("\t\t});\r\n");
      out.write("</script>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_t_entrada_0(PageContext _jspx_page_context)
    ...
    _jspx_th_t_entrada_0.setJspBody(new transportadoraEntrada_jspHelper( 0, _jspx_page_context, _jspx_th_t_entrada_0, null));
  ...
  private boolean _jspx_meth_t_property_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_0.setName("cdpessoa");
  ...
  private boolean _jspx_meth_t_janelaEntrada_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_janelaEntrada_0.setJspBody(new transportadoraEntrada_jspHelper( 1, _jspx_page_context, _jspx_th_t_janelaEntrada_0, null));
  ...
  private boolean _jspx_meth_t_tabelaEntrada_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_tabelaEntrada_0.setColumns(2);
    _jspx_th_t_tabelaEntrada_0.setJspBody(new transportadoraEntrada_jspHelper( 2, _jspx_page_context, _jspx_th_t_tabelaEntrada_0, null));
  ...
  private boolean _jspx_meth_n_panelGrid_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_n_panelGrid_0.setJspBody(new transportadoraEntrada_jspHelper( 3, _jspx_page_context, _jspx_th_n_panelGrid_0, null));
  ...
  private boolean _jspx_meth_t_property_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_1.setName("cnpj");
  ...
  private boolean _jspx_meth_n_input_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_n_input_0.setDynamicAttribute(null, "class", new String("buttonClass"));
    _jspx_th_n_input_0.setDynamicAttribute(null, "style", new String("height:22px; width:50px;"));
    _jspx_th_n_input_0.setValue(new String("OK"));
    _jspx_th_n_input_0.setDynamicAttribute(null, "onclick", new String("validaCNPJ()"));
  ...
  private boolean _jspx_meth_n_panelGrid_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_n_panelGrid_1.setStyle("display:none");
    _jspx_th_n_panelGrid_1.setDynamicAttribute(null, "id", new String("campos"));
    _jspx_th_n_panelGrid_1.setJspBody(new transportadoraEntrada_jspHelper( 4, _jspx_page_context, _jspx_th_n_panelGrid_1, null));
  ...
  private boolean _jspx_meth_t_property_4(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_4.setName("numeroCntrc");
    _jspx_th_t_property_4.setDynamicAttribute(null, "size", new String("15"));
  ...
  private boolean _jspx_meth_t_property_5(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_5.setName("certificacaoIso");
    _jspx_th_t_property_5.setDynamicAttribute(null, "onclick", new String("certificacaoIso9001()"));
    _jspx_th_t_property_5.setId("certificacaoIso");
  ...
  private boolean _jspx_meth_t_property_6(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_6.setName("validadeIso");
    _jspx_th_t_property_6.setId("validadeIso");
  ...
  private boolean _jspx_meth_t_property_7(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_7.setName("certificacaoSassmaq");
    _jspx_th_t_property_7.setDynamicAttribute(null, "onclick", new String("certificacaoSassmaq2()"));
    _jspx_th_t_property_7.setId("certificacaoSassmaq3");
  ...
  private boolean _jspx_meth_t_property_8(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_8.setName("validadeSassmaq");
    _jspx_th_t_property_8.setId("validadeSassmaq2");
  ...
  private boolean _jspx_meth_t_property_9(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_9.setName("certificacaoOutros");
    _jspx_th_t_property_9.setDynamicAttribute(null, "onclick", new String("check()"));
    _jspx_th_t_property_9.setId("certificacao");
  ...
  private boolean _jspx_meth_t_property_10(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_10.setId("descricao");
  ...
  private boolean _jspx_meth_t_property_11(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_11.setName("validadeCertificacaoOutros");
    _jspx_th_t_property_11.setId("validadeCertificacaoOutros");
  ...
  private boolean _jspx_meth_t_property_12(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_12.setName("possuiSeguro");
    _jspx_th_t_property_12.setDynamicAttribute(null, "onclick", new String("possuiSeguro2()"));
    _jspx_th_t_property_12.setId("possuiSeguro3");
  ...
  private boolean _jspx_meth_t_property_13(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_13.setName("rctrC");
    _jspx_th_t_property_13.setId("rctrC2");
  ...
  private boolean _jspx_meth_t_property_14(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_14.setName("rcfdC");
    _jspx_th_t_property_14.setId("rcfdC2");
  ...
  private boolean _jspx_meth_t_property_15(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_15.setName("danosAmbientais");
    _jspx_th_t_property_15.setId("danosAmbientais3");
  ...
  private boolean _jspx_meth_t_property_16(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_16.setName("areaLivre");
  ...
  private boolean _jspx_meth_t_property_17(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_17.setName("quantidadeFuncionariosMatriz");
  ...
  private boolean _jspx_meth_t_property_18(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_18.setName("totalFuncionariosBahia");
  ...
  private boolean _jspx_meth_t_property_19(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_t_property_19.setName("ativa");
    _jspx_th_t_property_19.doTag();
    return false;
  }

  private class transportadoraEntrada_jspHelper
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
    private javax.servlet.jsp.tagext.JspTag _jspx_parent;
    private int[] _jspx_push_body_count;

    public transportadoraEntrada_jspHelper( int discriminator, JspContext jspContext, javax.servlet.jsp.tagext.JspTag _jspx_parent, int[] _jspx_push_body_count ) {
